...
export const samplePlaces: Place[] = [
  {
    ...
    name: "연남 샘플 맛집",
    category: "food",
    description: "공개 지도에서 카테고리 필터와 상세 패널 흐름을 검증하기 위한 예시 장소입니다.",
    address: "서울 마포구 연남동",
    city: "서울",
    status: "published",
  ...
  },
  {
    ...
    name: "서면 주정차 제보",
    category: "report",
    description: "승인 대기 상태를 표현하고 운영자 검수 흐름을 보여주기 위한 샘플 제보입니다.",
    address: "부산 부산진구 서면로",
    city: "부산",
    status: "pending",
  ...
  },
  {
    ...
    name: "성심당 인근 공영주차장",
    category: "parking",
    description: "지도와 리스트를 함께 볼 때 주차 카테고리 흐름을 확인하기 위한 예시입니다.",
    address: "대전 중구 대종로",
    city: "대전",
    status: "published",
  ...
  },
  {
    ...
    name: "애월 해안 맛집 제보",
    category: "food",
    description: "수도권 밖 위치에서도 화면이 자연스럽게 동작하는지 확인하기 위한 샘플 데이터입니다.",
    address: "제주 제주시 애월읍",
    city: "제주",
    status: "pending",
